...
CStartGameDlg::CStartGameDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_STARTGAME_DIALOG, pParent)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}

void CStartGameDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
}

BEGIN_MESSAGE_MAP(CStartGameDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
...
// CStartGameDlg 消息处理程序

BOOL CStartGameDlg::OnInitDialog()
{
...
void CStartGameDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//显示。
HCURSOR CStartGameDlg::OnQueryDragIcon()
{
